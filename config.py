...
class Settings(BaseSettings):
    ...
    # Hardware API Key Generation
    HARDWARE_API_KEY_LENGTH: int = 64  # bytes
    ...
    WEIGHT_ANOMALY_THRESHOLD: float = 2.5  # Standard deviations
    ...
    # Model Classes (should match training labels)
    ...
    # Using FastAPI BackgroundTasks for MVP
    # Future: Consider Celery + Redis for production scale
